...
const Index: React.FC = () => (
  <Layout>
    <div tw="bg-white">
        ...
        <div tw="max-w-7xl mx-auto px-4 sm:px-6">
          <div tw="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            ...
            <nav tw="hidden md:flex space-x-10">
              <div tw="relative">
                <button
                  type="button"
                  className="group"
                  tw="bg-white rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  <span>Solutions</span>
                  <svg
                    tw="ml-2 h-5 w-5 text-gray-400 group-hover:text-gray-500"
            ...
            <div tw="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
              ...
              <a
                href="#"
                tw="whitespace-nowrap bg-blue-100 border border-transparent rounded-md py-2 px-4 inline-flex items-center justify-center text-base font-medium text-blue-700 hover:bg-blue-200"
              >
                Sign up
              </a>
            </div>
      ...
      <div tw="bg-gradient-to-b from-blue-50 via-white to-white">
        <div tw="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div tw="pb-16 xl:flex xl:items-center xl:justify-between">
            <div>
              <h1 tw="text-4xl font-extrabold sm:text-5xl sm:tracking-tight">
                ...
                <span tw="text-blue-600">$99 a month</span>
              </h1>
          ...
          <div tw="border-t border-gray-200 pt-16 xl:grid xl:grid-cols-3 xl:gap-x-8">
            <div>
              <h2 tw="text-base font-semibold text-blue-600 uppercase tracking-wide">
                Everything you need
              </h2>
            ...
            <div tw="mt-4 sm:mt-8 md:mt-10 md:grid md:grid-cols-2 md:gap-x-8 xl:mt-0 xl:col-span-2">
              <ul tw="divide-y divide-gray-200">
                <li tw="py-4 flex md:py-0 md:pb-4">
                  <svg
                  ...
                  <span tw="ml-3 text-base text-gray-500">
              ...
              <ul tw="border-t border-gray-200 divide-y divide-gray-200 md:border-t-0">
                <li tw="py-4 flex md:border-t-0 md:py-0 md:pb-4">
                  <svg
                    tw="flex-shrink-0 h-6 w-6 text-green-500"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
      ...
      <div tw="bg-blue-900">
        <div tw="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <h2 tw="text-3xl font-extrabold text-white">
            Frequently asked questions
          </h2>
          <div tw="mt-6 border-t border-blue-400 border-opacity-25 pt-10">
            <dl tw="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12">
              <div>
                <dt tw="text-lg leading-6 font-medium text-white">
                  What&#039;s the best thing about Switzerland?
                </dt>
                <dd tw="mt-2 text-base text-blue-200">
      ...
      <div tw="bg-blue-50">
        <div tw="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 tw="text-3xl font-extrabold tracking-tight text-blue-900 sm:text-4xl">
            <span tw="block">Ready to dive in?</span>
            <span tw="block text-blue-600">Start your free trial today.</span>
          </h2>
          <div tw="mt-8 flex lg:flex-shrink-0 lg:mt-0">
            <div tw="inline-flex rounded-md shadow">
              <a
                href="#"
                tw="bg-blue-600 border border-transparent rounded-md py-3 px-5 inline-flex items-center justify-center text-base font-medium text-white hover:bg-blue-700"
              >
                Get started
              </a>
            </div>
      ...
      <footer tw="max-w-7xl mx-auto py-16 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav tw="-mx-5 -my-2 flex flex-wrap justify-center">
          <div tw="py-2 px-5">
            <a href="#" tw="text-base text-gray-500 hover:text-gray-900">
              About
            </a>
          </div>
          <div tw="py-2 px-5">
        ...
        <p tw="mt-8 text-center text-base text-gray-500">
